...
int main(){
    ...
    if(move==1)
    {
        cout<<"You press the red button. Soon fleets of enormous ships arrive. One stops at Pluto to come and greet you. One comes to you and  say..."<<endl;
        continueGame();
        cout<<"We have just woken up and given our mission. We were told that two things could happen."<<endl;
        continueGame();
