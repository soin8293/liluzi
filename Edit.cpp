...
// Item randWeapon(){
//     srand(time(NULL));
//     //give weapon based on how far along the game they are
//     if(currentPlanetIndex >= 0 || currentPlanetIndex < 4)
    
// }

// int foundWeapon(){
//     int option;
//     cout<<"You found a "<<randWeapon
// }

int main(){
    cout<<"Welcome to SPACE INVADERS: VERTICAL UPRISE"<<endl;
    ...
    cout<<"Created enemy weapons..."<<endl;
    ...
    Item AlienPistol("M-3 Predator","items.txt",32);
    ...
    cout<<"Game loaded!!! Starting game..."<<endl;
    cout<<"==========Main Menu=========="<<endl;
    int option1;
    option1 = runMenu1();
    if(option1 == 3)
    ...
    cout<<player.getDescription()<<" opens her/his eyes for the first time in 21 years. \n";
    ...
    cout<<"history of humanity’s old home. He/she reads the following message: \n";
    cout<<"“You are a human sent by humans to explore and free our old home. \n";
    ...
    continueGame();
    cout<<"A war with the Space Invaders began, and after decades of war, us desperate \n";
    ...
    cout<<"is to take back this solar system. You have direct orders to kill any and all threatening \n";
    cout<<"life. There are several threats that you will encounter. Radiation skill plagues the \n";
    cout<<"planet and you will only be able to sustain this radiation without long term effects for \n";
    cout<<"only 9 days. It is likely that life in this solar system has developed and immunity \n";
    cout<<"to radiation. Space Invaders and other life in the solar system might still pose a threat\n";
    cout<<"to your presence. It is also very likely that the nuclear extinction attracted other \n";
    cout<<"alien life forms that want to take their share of this solar system. We have knowledge\n";
    cout<<"of Space Invader weaknesses given to us from mysterious transmission from humans left on\n";
    cout<<"Earth. Before you land on each planet, your spacecraft will be able to collect stored\n";
    ...
    cout<<"reinforcements will arrive. Now it’s our turn to be the invaders! Let’s go!!!"<<endl;
    continueGame();
            ...
            case 2:
                ...
                if(hit(currentPlanet.getCurrentWeather(),player.getHitChance()))
                {
                   ...
                   //Displays What just happened
                    cout<<currentPlanet.getCharacter(numOfEnemies).getDescription()<<" took "<<equippedItem.getDamage()<<" damage."<<endl;
    ...
    while(player.getHealth() > 0 && numOfEnemies > 0)
    {
        ...
        switch (move)
        {
            case 1:
                ...
                if(meds>0)
                {
                    cout<<"You eat one space invade shoe."<<endl;
                    player.setHealth(player.getHealth()+40);
                    meds--;
                }
                else
    ...
    cout<<"==========Welcome to "<<currentPlanet.getName()<<"========== \n";
    cout<<"***Planet Description***: "<<arrayOfPlanets[currentPlanetIndex].getDescription()<<"\n"<<endl;
    cout<<"NOTICE!: A Flamethrower is discovery in the dirt. Do you...? \n1)Take it\n2)Replace it with a gun in your inventory\n3)Leave it\n";
    cin>>move;
    cin.clear();
    switch(move){
        case 1:
    ...
    while(player.getHealth() > 0 && numOfEnemies > 0)
    {
        ...
        switch (move)
        {
            case 1:
                ...
                if(meds>0)
                {
                    cout<<"You each one beach ball."<<endl;
                    player.setHealth(player.getHealth()+40);
                    meds--;
                }
                else
                {
                    cout<<"You are banned from the beach."<<endl;
                }
                break;
            case 2:
                //Player attacks
    ...
    cout<<"==========Welcome to "<<currentPlanet.getName()<<"========== \n";
    cout<<"***Planet Description***: "<<arrayOfPlanets[currentPlanetIndex].getDescription()<<"\n"<<endl;
    cout<<"NOTICE!: A RayGun is discovery in the dirt. Do you...? \n1)Take it\n2)Replace it with a gun in your inventory\n3)Leave it\n";
    cin>>move;
    cin.clear();
    switch(move){
        case 1:
    ...
    while(player.getHealth() > 0 && numOfEnemies > 0)
    {
        ...
        switch (move)
        {
            case 1:
                ...
                if(meds>0)
                {
                    cout<<"You chug one Pineapple Fanta 7-Eleven-Slurpee®(Not a ad)."<<endl;
                    player.setHealth(player.getHealth()+60);
                    meds--;
                }
                else
                {
                    cout<<"You have brain freeze."<<endl;
                }
                break;
            case 2:
                //Player attacks
                ...
                {
                    cout<<"The Icee Bear missed his shot"<<endl;
                }
    ...
    cout<<"==========Welcome to "<<currentPlanet.getName()<<"========== \n";
    cout<<"***Planet Description***: "<<arrayOfPlanets[currentPlanetIndex].getDescription()<<"\n"<<endl;
    cout<<"NOTICE!: A MiniGun is discovery in the dirt. Do you...? \n1)Take it\n2)Replace it with a gun in your inventory\n3)Leave it\n";
    cin>>move;
    cin.clear();
    switch(move){
        case 1:
    ...
    cout<<"You arrive on "<<currentPlanetName<<" and bionic scans reveal there is "<<currentPlanet.getNumMonsters()<<" Space Inavder soldiers within your field of view, and they're MAD!"<<endl;
    cout<<"You currently have your "<<player.getItem(player.getEquipped()).getName()<<" equipped"<<endl;
    currentEnemyHealth = currentPlanet.getCharacter(numOfEnemies).getHealth();
    while(player.getHealth() > 0 && numOfEnemies > 0)
    {
    ...
    switch(move){
        ...
        case 2:
                ...
                break;
        case 3:
            cout<<"Your gonna lose...like staight up. \n";
            break;
        default:
            cout<<"It's yes or not son. \n";
            break;
    ...
    cout<<"You arrive on "<<currentPlanetName<<" and bionic scans reveal there is... THe ONE AND ONLY: "<<currentPlanet.getNumMonsters()<<" within your field of view and he's 6'6."<<endl;
    cout<<"You currently have your "<<player.getItem(player.getEquipped()).getName()<<" equipped"<<endl;
    currentEnemyHealth = currentPlanet.getCharacter(numOfEnemies).getHealth();
    while(player.getHealth() > 0 && numOfEnemies > 0)
    {
        ...
        switch (move)
        {
            case 1:
                ...
                if(meds>0)
                {
                    cout<<"You listen to one Playboi Carti snippet."<<endl;
                    player.setHealth(player.getHealth()+50);
                    meds--;
                }
                else
                {
                    cout<<"Playboi Carti will never drop Whole Lotta Red :( You're out of snippets."<<endl;
                }
                break;
            case 2:
                //Player attacks
                ...
                if(hit(currentPlanet.getCurrentWeather(),player.getHitChance()))
                {
                   ...
                   //Displays What just happened
                    cout<<currentPlanet.getCharacter(numOfEnemies).getDescription()<<" took "<<equippedItem.getDamage()<<" damage. He slowly shrinks."<<endl;
    ...
    if(player.getHealth()<=0)
    {
        cout<<"Game Over. So close!"<<endl;
        return 0;
    }
    
    //Did you defeat all the enemies?
    if(numOfEnemies == 0)
        cout<<"### You defeated...Lil Uzi. ###"<<endl;
